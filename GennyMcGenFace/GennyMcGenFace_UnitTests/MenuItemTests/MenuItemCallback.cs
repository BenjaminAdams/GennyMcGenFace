...
using GennyMcGenFace.GennyMcGenFace;

namespace GennyMcGenFace_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new GennyMcGenFacePackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(GennyMcGenFace.GennyMcGenFace.GuidList.guidGennyMcGenFaceCmdSet, (int)GennyMcGenFace.GennyMcGenFace.PkgCmdIDList.cmdGennyGenClass);
