...
namespace Microsoftdfsdf.testPackageEditorTmp
{
    ...
    /// </summary>
    [Guid(GuidList.guidtestPackageEditorTmpEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private testPackageEditorTmpPackage editorPackage;
        private ServiceProvider vsServiceProvider;

        public EditorFactory(testPackageEditorTmpPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidtestPackageEditorTmpEditorFactory;
            pgrfCDW = 0;
