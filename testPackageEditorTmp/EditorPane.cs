...
namespace Microsoftdfsdf.testPackageEditorTmp
{
    ...
    //     - An empty testpackageeditortmp file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.testpackageeditortmp. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.testpackageeditortmp, MyExtFile2.testpackageeditortmp... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.testpackageeditortmp|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.testpackageeditortmp - our empty testpackageeditortmp file
    ...
    //    - #107 - the ID of "testpackageeditortmp"
    ///////////////////////////////////////////////////////////////////////////////
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".testpackageeditortmp";
        ...
        private testPackageEditorTmpPackage myPackage;
        ...
        public EditorPane(testPackageEditorTmpPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        #endregion "Window.Pane Overrides"

        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the testpackageeditortmp document
        /// which will show up in the properties window
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(testPackageEditorTmpPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidtestPackageEditorTmpCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidtestPackageEditorTmpCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        #endregion IEditor Implementation
        ...
        #endregion IExtensibleObject Implementation

        int Microsoft.VisualStudio.OLE.Interop.IPersist.GetClassID(out Guid pClassID)
        {
            pClassID = GuidList.guidtestPackageEditorTmpEditorFactory;
            return VSConstants.S_OK;
        }
        ...
        #endregion IVsDocDataFileChangeControl Members
        ...
        #endregion IVsToolboxUser Interface
        ...
        #endregion IVsStatusbarUser Members
        ...
        #endregion IVsFindTarget Members
        ...
        #endregion IVsTextImage members
        ...
        #endregion IVsTextSpanSet Members
        ...
        #endregion IVsTextBuffer Members
        ...
        #endregion IVsCodeWindow Members
        ...
        #endregion IVsTextLines Members
    }
}