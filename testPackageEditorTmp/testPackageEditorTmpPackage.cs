...
namespace Microsoftdfsdf.testPackageEditorTmp
{
    ...
    [ProvideEditorExtension(typeof(EditorFactory), ".testpackageeditortmp", 50,
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}",
              TemplateDir = "Templates",
              NameResourceID = 105,
              DefaultName = "testPackageEditorTmpsdfsdf")]
    [ProvideKeyBindingTable(GuidList.guidtestPackageEditorTmpEditorFactoryString, 102)]
    ...
    [Guid(GuidList.guidtestPackageEditorTmpPkgString)]
    public sealed class testPackageEditorTmpPackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public testPackageEditorTmpPackage()
        {
