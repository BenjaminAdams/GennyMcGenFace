...
namespace testPackageEditorTmp_IntegrationTests
{
    ...
    public class EditorTest
    {
        ...
        public void ValidateNewFileOpenedWithEditor()
        {
            UIThreadInvoker.Invoke((ThreadInvoker)delegate()
            {
                ...
                EnvDTE.Window win = dte.ItemOperations.NewFile(@"testPackageEditorTmp Files\testPackageEditorTmp", name, EnvDTE.Constants.vsViewKindPrimary);
